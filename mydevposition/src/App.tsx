...
function App() {
  ...
  const getResultContent = () => {
    ...
    if (resultPosition === "프론트엔드") {
      ...
      return "책을 살 때도, 식당을 고를 때도 언제나 외관을 먼저 보게 되는 당신! 예쁘고 효율적인 디자인을 싫어하는 사람은 없어. 아무리 잘 만든 프로젝트여도 디자인이 별로라면 활용도가 떨어진다. 미적 감각이 뛰어난 것은 기본, 창의력과 상상력까지 겸비해야 맡을 수 있는 디자인 포지션이 어울려요. 멋쟁이 사자처럼에서 당신의 감각을 보여주세요!";
    }
